...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\laragon\www\desa-karangrejo\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.E:\\laragon\\www\\desa-karangrejo\\public\\storage',
...
'signed','throttle','verified','admin','operator',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','home','posts.index','posts.category',
'posts.search','posts.show','profile','history','vision-mission',
'organization','services','pages.show','galleries.index','galleries.photos',
'galleries.videos','galleries.category','galleries.show','contact.index','contact.store',
'contact.office-hours','api.announcements.active','api.village.stats','dashboard','admin.dashboard',
'admin.posts.index','admin.posts.create','admin.posts.store','admin.posts.show','admin.posts.edit',
'admin.posts.update','admin.posts.destroy','admin.categories.index','admin.categories.create','admin.categories.store',
'admin.categories.edit','admin.categories.update','admin.categories.destroy','admin.categories.bulk-action','admin.categories.toggle-status',
'admin.categories.export','admin.categories.select','admin.pages.index','admin.pages.create','admin.pages.store',
'admin.pages.show','admin.pages.edit','admin.pages.update','admin.pages.destroy','admin.galleries.index',
'admin.galleries.create','admin.galleries.store','admin.galleries.show','admin.galleries.edit','admin.galleries.update',
'admin.galleries.destroy','admin.village-data.index','admin.village-data.create','admin.village-data.store','admin.village-data.show',
'admin.village-data.edit','admin.village-data.update','admin.village-data.destroy','admin.announcements.index','admin.announcements.create',
'admin.announcements.store','admin.announcements.show','admin.announcements.edit','admin.announcements.update','admin.announcements.destroy',
'admin.documents.index','admin.documents.create','admin.documents.store','admin.documents.show','admin.documents.edit',
'admin.documents.update','admin.documents.destroy','admin.messages.index','admin.messages.show','admin.messages.update',
'admin.messages.destroy','admin.users.index','admin.users.create','admin.users.store','admin.users.show',
'admin.users.edit','admin.users.update','admin.users.destroy','admin.settings.index','admin.settings.update',
'admin.api.stats','admin.api.notifications','download.document','download.forms','sitemap',
'feed','health','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'admin.categories.index','admin.dashboard','admin.posts.create','admin.posts.index','auth.confirm-password',
...
'components.responsive-nav-link','components.secondary-button','components.text-input','dashboard','frontend.contact',
'frontend.galleries.index','frontend.home','frontend.pages.profile','frontend.partials.footer','frontend.partials.navbar',
'frontend.posts.index','frontend.posts.show','layouts.admin','layouts.app','layouts.frontend',
