<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top">
    <div class="container align-items-center">
        <a class="navbar-brand d-flex align-items-center gap-2 py-0" href="{{ route('home') }}" style="min-width:220px;">
            <img src="{{ asset('images/uisi.jpg') }}" alt="Logo Desa Karangrejo" style="height:38px;width:auto;object-fit:contain;" onerror="this.onerror=null;this.src='https://via.placeholder.com/38x38?text=Logo';">
