            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card border-0 shadow-sm gallery-item" data-bs-toggle="modal" data-bs-target="#galleryModal{{ $gallery->id }}">
                    <div class="position-relative overflow-hidden">
                        @if($gallery->type === 'video' && is_array($gallery->images) && count($gallery->images) > 0)
                            <video class="card-img-top" style="height: 250px; object-fit: cover; cursor: pointer;" muted autoplay loop controls preload="metadata">
                                <source src="{{ asset('storage/' . $gallery->images[0]) }}" type="video/mp4">
