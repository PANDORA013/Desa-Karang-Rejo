                ...
                <div class="card mb-4 border-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <p class="text-muted mb-0">{{ $officeInfo['address'] ?? 'Jl. Raya Karangrejo No. 123, Kecamatan Sukodadi, Kabupaten Lamongan, Jawa Timur 62253' }}</p>
                        </div>
                        <div class="mb-3">
                            <h6 class="fw-bold">Telepon</h6>
                            <p class="text-muted mb-0">{{ $officeInfo['phone'] ?? '(0322) 123456' }}</p>
                        </div>
                        <div class="mb-3">
                            <h6 class="fw-bold">Email</h6>
                            <p class="text-muted mb-0">{{ $officeInfo['email'] ?? 'info@desakarangrejo.id' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="mb-2">
                            ...
                            <span class="text-muted">081234567890</span>
                        </div>
                        <div class="mb-2">
                            <strong>Sekretaris Desa</strong><br>
                            <span class="text-muted">081234567891</span>
                        </div>
                        <div class="mb-2">
                            <strong>Babinsa</strong><br>
                            <span class="text-muted">081234567892</span>
                        </div>
                        <div>
                            <strong>Bhabinkamtibmas</strong><br>
                            <span class="text-muted">081234567893</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body p-0">
                        <div style="height: 400px; background: #f8f9fa; position: relative;">
                            <!-- Google Maps Embed - ganti dengan koordinat yang sesuai -->
                            <iframe 
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3958.123456789!2d112.123456!3d-7.123456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zN8KwMDcnMjQuNCJTIDExMsKwMDcnMjQuNCJF!5e0!3m2!1sen!2sid!4v1234567890"
                                width="100%" 
                                height="400" 
                                style="border:0;" 
                                allowfullscreen="" 
