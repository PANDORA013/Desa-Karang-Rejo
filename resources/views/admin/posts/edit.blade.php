                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="imagePreview" class="mt-3" style="{{ $post->featured_image_url ? '' : 'display: none;' }}">
                                    <img id="preview" src="{{ $post->featured_image_url ?? '' }}" alt="Preview" class="img-fluid rounded" style="max-height: 200px;">
                                </div>
                            </div>
                            <!-- Published Date -->
