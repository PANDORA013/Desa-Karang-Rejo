...
class UpdateVillageDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $villageData = [
            ...
            // Sosial dan Kesejahteraan (menggunakan 'kesehatan' sebagai kategori yang tersedia)
            [
                'type' => 'kesehatan',
            ...
            // Ketenagakerjaan (menggunakan 'ekonomi' sebagai kategori yang tersedia)
            [
                'type' => 'ekonomi',
            ...
            // Pertanian & Potensi (menggunakan 'ekonomi' sebagai kategori yang tersedia)
            [
                'type' => 'ekonomi',
                'label' => 'Fokus Wilayah',
            ...
            // Bencana dan Mitigasi (menggunakan 'geografis' sebagai kategori yang tersedia)
            [
                'type' => 'geografis',
            ...
            // Administrasi Pemerintahan (menggunakan 'demografi' sebagai kategori yang tersedia)
            [
                'type' => 'demografi',
                'label' => 'Kategori Desa',
